...
import CurrentConversation from "./components2/conversation/current-conversation";
import SideBar from "./components2/layout/side-bar";
import Login from "./components2/user/login";
import ImagePreviewer from "./components2/message/image-previewer.vue";
import QrCodeList from "./components2/qr-code-list";
import { translateGroupSystemNotice } from "./utils/common";
import GroupLive from "./components2/group-live/index";
import Calling from "./components2/message/trtc-calling/calling-index";
...
export default {
  ...
  methods: {
    async reStart() {
      ...
      this.tim
        .login({
          userID: "550@3",
          userSig:
            "eJw1jsEKgkAURf9l1iFPZ55NQtCyMBEqKNyV85SH0yQmGkX-nmkt77n3wH2Jw3bv0aPmhkTkI2IAALORdtSISAQeiCnfTXWuazbDTgEgSA1qatiQa7ngUUCElfwrXA5E2iOt3S2LLRfGaJJxn7sdpkmm5Ka07qTSjp75pa*S5U9s*fr9E-pazfUCw-cHAa0xMw__"
        })
        .then(() => {
          this.loading = false;
    ...
    onReceiveMessage({ data: messageList }) {
      this.$bus.$emit("showMessage", true);
